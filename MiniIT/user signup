...
def run_user_page2():
  ...
  label = customtkinter.CTkLAbel(frame, text="Wlecome to Pick Me Up for MMU!", font=special_font)
  label.pack(pady=20, padx=20)
  label.place(relx=0.5, rely=0.15, anchor="center")

  label1 = customtkinter.CTkLabel(frame, text="Please sign up for our app using your MMU ID, name, Phone Number, and Password. Next time you can just login using ID and password.", font=normal_font)
  ...
  buttonsign_up.place(relx=0.5, rely=0.75, anchor="center")
